...
import com.example.springbootmq.service.impl.MessageListener;
...
public class RocketMQConsumerConfiguration {
    ...
    public DefaultMQPushConsumer getRocketMQConsumer() throws RocketMQException {
        ...
        try {
            ...
            consumer.start();
            System.out.println(String.format("consumer is start !!! groupName:{},topic:{},namesrvAddr:{}",groupName,topic,namesrvAddr));

package com.example.springbootjwt.util.runner;


import com.example.springbootjwt.support.config.KeyConfiguration;
import com.example.springbootjwt.util.jwt.RsaKeyHelper;
...
public class AuthServerRunner implements CommandLineRunner {
    ...
    private static final String REDIS_USER_PRI_KEY = "BOOT:AUTH:JWT:PRI";
    private static final String REDIS_USER_PUB_KEY = "BOOT:AUTH:JWT:PUB";
    private static final String REDIS_SERVICE_PRI_KEY = "BOOT:AUTH:CLIENT:PRI";
    private static final String REDIS_SERVICE_PUB_KEY = "BOOT:AUTH:CLIENT:PUB";

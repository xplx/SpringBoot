package com.example.springbootjwt.support.config;
...
public class SwaggerConfig {
    ...
    private List<Parameter> getPars() {
        ...
        ticketPar.name("Authorization").description("Authorization").modelRef(new ModelRef("string")).parameterType("header").required(false).build();

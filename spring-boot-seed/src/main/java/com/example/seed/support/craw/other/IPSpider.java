package com.example.seed.support.craw.other;

import com.example.seed.support.craw.util.HttpUtils;
...
//    private final String HTTPS_API = "https://www.xicidaili.com/wn/";
    private final String HTTP_API = "https://www.kuaidaili.com/free/inha/";
    private final String HTTPS_API = "https://www.kuaidaili.com/free/inha/";
    ...
    public List<IPBean> crawlHttp(){
        ...
        for (int page = pages - 20; page <= pages; page++){
    ...
    private List<IPBean> crawl(String api, int index){
        ...
        for (int i = 0; i < eles.size(); i++){
            ...
            String ip = ele.children().get(0).text();
            int port = Integer.parseInt(ele.children().get(1).text().trim());
            String typeStr = ele.children().get(3).text().trim();
            int type;
